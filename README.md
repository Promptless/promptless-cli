<p align="center" style="padding-top:32px;">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Promptless/promptless-cli/main/docs/img/logo-text-v1-dark.png">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Promptless/promptless-cli/main/docs/img/logo-text-v1.png">
    <img src="https://raw.githubusercontent.com/Promptless/promptless-cli/main/docs/img/logo-text-v1.png" alt="promptless cli" width="300">
  </picture>
</p>
